...
const CONTRACT: Record<keyof typeof ENTRIES, readonly string[]> = {
  "aruna/server": [
    ...
    "InferOutput",
    "InferSignalPayload",
    // Persistence. The DataStoreService adapter itself is Roblox-only and lives
    // on `aruna/roblox`, but everything a store author writes against is shared.
    "defineStore",
    "definePlayerStore",
    "createStore",
    "createPlayerStore",
